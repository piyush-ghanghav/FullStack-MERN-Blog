...
const AddCommentForm = ({ articleName, setArticleInfo }) => {
    ...
    return (
        <form className='shadow rounded px-8 pt-6 pb-8 mb-4'>
            ...
            <button onClick={() => addComments()} type='submit' className='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none
        focus:shadow-outline'>Add Comment</button>
